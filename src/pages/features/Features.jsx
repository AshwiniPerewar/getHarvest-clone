      ...
      <Box borderY={"1px solid red"} mt="10%">
        <Box display={"flex"} alignItems="center" mt="10%" ref={invoice}>
          <Box ml="15px">
            ...
            <Box
              ...
              paddingRight="30px"
            >
              Turn your team’s tracked time and expenses into invoices and
              collect payment quickly with integrated online payments.
            </Box>
            <Button
              colorScheme={"orange"}
              size="lg"
        ...
        >
          <Box width={"32%"}>
            ...
            <Box fontWeight={"500"} fontSize="20px">
              Easily create and send accurate invoices using your team’s time
              and expenses already tracked in Harvest.
            </Box>
          </Box>
          <Box width={"32%"}>
            <Box>
          ...
          <Box width={"32%"}>
            ...
            <Box fontWeight={"500"} fontSize="20px">
              Automatically copy your Harvest invoices and payments to
              QuickBooks Online or Xero for simplified accounting.
            </Box>
          </Box>
        </Box>
      </Box>
