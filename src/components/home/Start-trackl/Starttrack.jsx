  ...
  return (
    ...
    <Box className={styles.innerbox}>
     ...
     <Flex marginTop="2rem" gap="1rem" className={styles.innerflex}>
      <Button _hover={{cursor:"pointer",bgColor:"#ea753f"}} bgColor="#fa5d00" color="white" borderRadius="15px" className={styles.button} fontSize="19px" height="3rem">Try Harvest free</Button>
