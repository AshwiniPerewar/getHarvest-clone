  ...
  return (
    <Box>
      ...
      <Box width="90%" margin="auto" textAlign="start" marginTop="4rem">
       ...
       <Text fontSize="39px" className={styles.customer_heading} >Helping teams thrive since 2006</Text>
       <Text fontSize="26px"  className={styles.customer_heading}  marginTop="1rem">Teams of all sizes, types, and industries trust Harvest to track their time.</Text>
       <Slideshow/>
