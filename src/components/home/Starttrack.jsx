...
export const Starttrack = () => {
  ...
  return (
    ...
    <Box width="45%" marginTop="4rem"  marginLeft="5%">
     <Text fontSize="39px" className={styles.feature_heading} lineHeight="48px">Start tracking time today</Text>
     <Text fontSize="26px"  className={styles.feature_heading}  marginTop="1rem">Join 70,000+ companies spending their time wisely with Harvest.</Text>
